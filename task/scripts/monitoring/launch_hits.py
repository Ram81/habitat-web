...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--scene-dataset", type=str, default="hm3d"
    )
    parser.add_argument(
    ...
    task_scenes = scenes_dict[args.scene_dataset][args.split]
    print("using {}:{} scenes".format(args.scene_dataset, args.split))

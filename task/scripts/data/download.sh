...
python "${prefix}/scripts/data/download_hit_data.py" --db_path $db_path --dump_path "${prefix}/data/hit_data/visualisation/unapproved_hits" --prefix $output_prefix --mode $mode --from-date "$from_date"
